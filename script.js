...
function showFirstMessage() {
    ...
    const messages = [
        'قبل كل حاجة تعالى نرجع',
        'لليوم اللي بدأت فيه الحكاية...',
        '٣١ مايو ٢٠٠٦'
    ];
...
function showSecondMessage() {
    ...
    const messages = [
        'في الليلة ديه تحديدًا كان ليلة...',
        ' إكمال القمر لهلاله زي ما انتي شايفة',
        'واتولدتي في تمام هلال القمر ❤️'
    ];
...
function showThirdMessage() {
    ...
    const messages = [
        '    انهاردة بتتمي ال19 من عمرك في خير وسعادة عارف ان السنة الي فاتت كان فيها كتير لكن انتي قدها🔥',
        '  ما تيأسيش من الي فات والي جاي هيبقي كله خير والله❤️ '
    ];
